...
const Footer = () => {
    ...
    return (
        <div data-scroll data-scroll-section data-scroll-speed="-.1" className='w-full h-screen bg-[#F1F1F1] flex pt-20 px-14 rounded-tl-3xl rounded-tr-3xl'>
            <div className='w-1/2 relative'>
                ...
                <svg className='absolute bottom-[5%]' width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='w-1/2 relative'>
                <h1 className='font-["Bebas_Neue"] text-[8vw] leading-[7vw]'>PRESENTATIONS</h1>

                <div className='font-regular'>
                    <div className='w-full py-5'>
                        <span className='mb-2 block'>S:</span>
                    ...
                    <div className='w-full flex justify-between'>
                        ...
                        <div className=''>
                            <span className='mb-2 block'>M:</span>
                            <div className='flex flex-col'>
                                <a href="">Home</a>
                                <a href="">Services</a>
                                <a href="">Our work</a>
                                <a href="">About us</a>
                                <a href="">Insights us</a>
                                <a href="">Contact us</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className=''>
                        <span className='mb-2 block'>E:</span>
                        <div className='flex flex-col w-fit'>
                            <a href="">hello@ochi.design</a>
                        </div>
                    </div>

                    <div className='w-full absolute bottom-[5%] flex  justify-between text-zinc-300'>
                        <div>
                            <span>© ochi design 2024.</span>
                            <a className='after:w-0' href="">Legal term</a>
                        </div>

                        <div>
                            <a className='after:w-0' href="">Website by Obys</a>
                        </div>
                    </div>
                </div>
