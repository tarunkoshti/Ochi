    ...
    return (
        <div data-scroll data-scroll-section data-scroll-speed="-.1" className='w-full min-h-screen bg-[#F1F1F1] md:flex pt-20 px-14 rounded-tl-3xl rounded-tr-3xl'>
            <div className='w-1/2 md:relative'>
                ...
                <svg className='hidden md:block absolute bottom-[5%]' width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='w-full md:w-1/2 md:relative'>
                ...
                <div className='font-regular'>
                    ...
                    <div className='w-full pb-5 md:absolute bottom-[5%] flex  justify-between text-zinc-300'>
                        <div>
